...
object VolleyHttp {
    ...
    const val API_GET_ALL = "m6-l7-t1-j"
    const val API_GET_SINGLE = "m6-l7-t1-j/"
    const val API_PUT = "m6-l7-t1-j/"
    const val API_DELETE = "m6-l7-t1-j/"
    const val API_POST = "m6-l7-t1-j"
