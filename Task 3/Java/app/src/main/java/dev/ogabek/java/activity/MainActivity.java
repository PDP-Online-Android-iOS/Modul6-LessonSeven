...
public class MainActivity extends AppCompatActivity {
    ...
    private void get() {
        ...
        RetrofitHttp.employeeService.get().enqueue(new Callback<List<Employee>>() {
            @Override
    ...
    private void post(Employee employee) {
        loading.setVisibility(View.VISIBLE);
        RetrofitHttp.employeeService.post(employee).enqueue(new Callback<Employee>() {
            @Override
    ...
    private void put(Employee employee) {
        loading.setVisibility(View.VISIBLE);
        RetrofitHttp.employeeService.put(employee.getId(), employee).enqueue(new Callback<Employee>() {
            @Override
            public void onResponse(Call<Employee> call, Response<Employee> response) {
                loading.setVisibility(View.GONE);
                Logger.d(TAG, response.toString());
    ...
    private void delete(Employee employee) {
        loading.setVisibility(View.VISIBLE);
        RetrofitHttp.employeeService.delete(employee.getId()).enqueue(new Callback<Employee>() {
            @Override
            public void onResponse(Call<Employee> call, Response<Employee> response) {
                loading.setVisibility(View.GONE);
                Logger.d(TAG, response.toString());
