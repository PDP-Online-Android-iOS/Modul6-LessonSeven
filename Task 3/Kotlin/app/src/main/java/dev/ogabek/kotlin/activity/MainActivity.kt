...
class MainActivity : AppCompatActivity() {
    ...
    private fun get() {
        ...
        RetrofitHttp.employeeService.get().enqueue(object : Callback<List<Employee>>{
    ...
    private fun post(employee: Employee) {
        RetrofitHttp.employeeService.post(employee).enqueue(object : Callback<Employee>{
    ...
    private fun put(employee: Employee) {
        RetrofitHttp.employeeService.put(employee.id, employee).enqueue(object : Callback<Employee>{
            override fun onResponse(call: Call<Employee>, response: Response<Employee>) {
                loading.visibility = View.GONE
                Logger.d(TAG, response.toString())
                get()
    ...
    private fun delete(employee: Employee) {
        RetrofitHttp.employeeService.delete(employee.id).enqueue(object : Callback<Employee>{
            override fun onResponse(call: Call<Employee>, response: Response<Employee>) {
                loading.visibility = View.GONE
                Logger.d(TAG, response.toString())
                get()
