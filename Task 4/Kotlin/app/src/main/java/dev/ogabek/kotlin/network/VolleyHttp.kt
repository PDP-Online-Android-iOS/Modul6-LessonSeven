...
object VolleyHttp {
    ...
    operator fun get(api: String, params: HashMap<String, String>, volleyHandler: VolleyHandler) {
        val request: StringRequest = object : StringRequest(
            ...
            { error -> volleyHandler.onError(error.message.toString()) }
        ) {
    ...
    const val API_GET_ALL = "employees"
    const val API_GET_SINGLE = "employee/"
    const val API_PUT = "update/"
    const val API_DELETE = "delete/"
    const val API_POST = "create"
